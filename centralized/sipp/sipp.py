...
class SippPlanner(SippGraph):
    ...
    def compute_plan(self):
        ...
        self.sipp_graph[self.start].g = 0.0
        ...
        while not goal_reached:
            ...
            for successor in successors:
                if (
                    ...
                    > self.sipp_graph[s.position].g + cost
                ):
                    self.sipp_graph[successor.position].g = (
                        self.sipp_graph[s.position].g + cost
                    )
                    ...
                    self.sipp_graph[successor.position].f = self.sipp_graph[
                        successor.position
                    ].g + self.get_heuristic(successor.position)
